...
export const metadata: Metadata = {
  title: 'Services | GEVA VENTURES',
  description: 'Elevator installation, escalator installation, automatic doors, procurement and maintenance services from GEVA VENTURES.',
};
  ...
  return (
    <main>
      ...
      <div className='relative h-[420px] lg:h-[500px] overflow-hidden flex items-center'>
        <Image src={heroImg} alt='GEVA Ventures Services' className='absolute inset-0 w-full h-full object-cover object-center' priority />
