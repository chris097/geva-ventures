...
export const metadata: Metadata = {
  title: 'About Us | GEVAC VENTURES',
  description: 'GEVAC VENTURES is the dedicated elevators, escalators and automatic doors business of Gevac Global Services Ltd, delivering modern vertical mobility systems across Nigeria.',
};
  ...
  return (
    <main className='bg-slate-950'>
      ...
      <div className='relative h-[420px] lg:h-[500px] overflow-hidden flex items-center'>
        <Image src={aboutImg} alt='GEVAC VENTURES team on site' className='absolute inset-0 w-full h-full object-cover object-center' priority />
        ...
        <div className='relative z-10 w-[90%] mx-auto max-w-6xl mt-16'>
          ...
          <Reveal>
            <h1 className='font-tillitium font-extrabold sm:font-black text-white text-4xl sm:text-5xl lg:text-7xl leading-none tracking-tighter'>
              GEVAC <span className='text-transparent bg-clip-text bg-gradient-to-r from-primary to-sky-300'>VENTURES.</span>
            </h1>
          </Reveal>
          <Reveal>
